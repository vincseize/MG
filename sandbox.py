...
#         graphPath='/u/'+projectLower+'/Users/COM/Presets/Graphs/OCC/USECASE/'+FILM+'/'+FILM+'_'+mySHOT+'.inkGraph'
#         graphPathLocal='/u/'+projectLower+'/Users/'+USER+'/Presets/Graphs/occ_USECASE_'+mySHOT+'.inkGraph' # debug
