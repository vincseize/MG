...
parser.add_argument('brk',nargs='?',help='Search brocken a7')
...
# #########################################################################################################################
	...
	for root, dirnames, filenames in os.walk(self.source, topdown=True, onerror=None, followlinks=True): # topdown=False moins efficient que True
	    #print filenames
